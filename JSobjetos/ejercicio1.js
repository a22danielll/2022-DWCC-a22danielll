...
function finSemana(fecha5) {
  const day = fecha5.getDay();
  if (day == 0 && day == 6) {
...
//3. Dado un array cos días da semana, indica se algún comeza por ‘s’. Comproba tamén se todos acaban en ‘s’Exercicios
